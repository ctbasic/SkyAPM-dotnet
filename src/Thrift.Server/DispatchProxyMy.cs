...
namespace System.ReflectionMy
{
    ...
    /// </summary>
    public abstract class DispatchProxyMy
    {
        protected DispatchProxyMy()
        {
        }
        ...
        public static T Create<T, TProxy>()
            where TProxy : DispatchProxyMy
        {

            return (T)DispatchProxyGeneratorMy.CreateProxyInstance(typeof(TProxy), typeof(T));
        }


        public static object Create(Type TProxy, Type T)
        {
            return DispatchProxyGeneratorMy.CreateProxyInstance(TProxy, T);
        }
    }
}
#endif